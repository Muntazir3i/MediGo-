...
function Sidebar() {
  return (
         ...
         <aside className="fixed bottom-0 left-0 h-[10vh]  w-full flex-none lg:static lg:h-screen lg:w-35 lg:flex-col lg:gap-5 bg-blue-200 p-4 flex flex-row items-center justify-center gap-2">
